...
export default function Menu() {
      return (
        <div className="min-h-screen bg-white flex">
          {/* Sidebar */}
          <aside className="w-64 bg-purple-600 text-white flex flex-col justify-between p-6">
            {/* Perfil */}
            <div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-200">sistema de edição e delete</p>
                </div>
              </div>
              <nav className="mt-10">
                <ul>
            ...
            <div>
              <p className=" flex justify-center w-full bg-purple-500 hover:bg-purple-700 text-white py-2 px-4 rounded-lg">
                Logout
              </p>
            </div>
          </aside>
